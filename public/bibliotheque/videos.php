...
$art = new article();
			...
			$req1=mysql_query('select * from article where idTypArt=4') or die(mysql_error());
 ...
 echo' <div class="col-md-6">
    <div class="thumbnail">
    <iframe  width="490" height="290" src="http://localhost/plateforme/banque de donnees/article/'.$aff1['lienArt'].'" frameborder="0" allowfullscreen></iframe>
      <div class="caption">
